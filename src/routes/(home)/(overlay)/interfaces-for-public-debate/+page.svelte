<script lang="ts">
    ...
    // Each project's public site. Fill in the real URLs when available.
    const projects = [
        {
...
>
    ...
    <IntroductoryParagraph>
        <p>
            To bring <a
                href={resolve("/participatory-data-practices") +
                    "#data-scraping"}>data scraping</a
            ...
            >, <a
                href={resolve("/participatory-data-practices") +
                    "#data-plotting"}>data plotting</a
            >, and <a
                href={resolve("/participatory-data-practices") +
                    "#data-mapping"}>data mapping</a
        ...
        {#each projects as project (project.title)}
            <div class="project-slide">
                ...
                <div class="media page-subgrid">
                    <div class="placeholder">Project visualisation</div>
                </div>
